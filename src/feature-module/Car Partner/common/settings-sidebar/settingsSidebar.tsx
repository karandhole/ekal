      ...
      <ul>
        ...
        <li>
          <ul className="sidebar-links pb-3 mb-3 border-bottom">
            <li className={location.pathname.includes(all_routes.carPartnerProfileSettings)?'active':''}>
              <Link to={all_routes.carPartnerProfileSettings}>
                <i className="ti ti-user-edit me-2" />
                <span>Profile</span>
                <span className="track-icon" />
              </Link>
            </li>
            <li className={location.pathname.includes(all_routes.carPartnerSecuritySettings)?'active':''}>
              <Link to={all_routes.carPartnerSecuritySettings}>
                <i className="ti ti-lock me-2" />
                <span>Security</span>
              </Link>
            </li>
            {/* <li className={location.pathname.includes(all_routes.carPartnerNotificationsSetting)?'active':''}>
              <Link to={all_routes.carPartnerNotificationsSetting}>
                <i className="ti ti-bell me-2" />
                <span>Notifications</span>
              </Link>
            </li>
            <li className={location.pathname.includes(all_routes.carPartnerIntegrationsSettings)?'active':''}>
              <Link to={all_routes.carPartnerIntegrationsSettings}>
                <i className="ti ti-device-nintendo me-2" />
                <span>Integrations</span>
              </Link>
            </li>
            <li className={location.pathname.includes(all_routes.carPartnerTrackerSetting)?'active':''}>
              <Link to={all_routes.carPartnerTrackerSetting}>
