...
const UserBookingUpcoming = () => {
  ...
  const BookingId = (res: any) => (
    <Link to="#" data-bs-toggle="modal" data-bs-target="#upcoming_modal" className="bookbyid"
  ...
  const statusBadge = () => <span className="badge badge-light-secondary">Upcoming</span>;
  ...
  const action = (res: any) => (
    <div className="dropdown dropdown-action">
      ...
      <div className="dropdown-menu dropdown-menu-end">
        <Link className="dropdown-item" to="#" data-bs-toggle="modal" data-bs-target="#upcoming_modal"
          onClick={() => setSelectedBooking(res.originalData)}>
  ...
  const sortLabel = sortMode === "asc" ? "Sort By Ascending" : sortMode === "alpha" ? "Sort By Alphabet" : sortMode === "desc" ? "Sort By Descending" : "Sort By Relevance";
  ...
  return (
    <>
              ...
              <div className="card book-card flex-fill mb-0">
                <div className="card-header">
                  <div className="row align-items-center">
                    <div className="col-md-5"><h4>Upcoming <span>{filteredData.length}</span></h4></div>
                ...
                <div className="card-body">
                  {loading ? (
                    ...
                    <div className="table-responsive dashboard-table">
                      <DataTable className="table datatable" value={filteredData} emptyMessage="No upcoming bookings.">
      ...
      <BookingModal booking={selectedBooking} userInfo={userInfo} modalId="upcoming_modal" />
    </>
  );
};
