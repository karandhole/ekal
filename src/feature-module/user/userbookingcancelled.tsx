...
const UserBookingCancelled = () => {
  ...
  useEffect(() => {
    ...
    const fetch = async () => {
      try {
        ...
        console.error("Failed to fetch cancelled:", e);
      } finally {
        setLoading(false);
      }
    };
  ...
  const BookingId = (res: any) => (
    <Link to="#" data-bs-toggle="modal" data-bs-target="#cancelled_modal" className="bookbyid"
  ...
  const statusBadge = () => <span className="badge badge-light-danger">Cancelled</span>;
  ...
  const action = (res: any) => (
    <div className="dropdown dropdown-action">
      ...
      <div className="dropdown-menu dropdown-menu-end">
        <Link className="dropdown-item" to="#" data-bs-toggle="modal" data-bs-target="#cancelled_modal"
  ...
  return (
    <>
                  ...
                  <div className="col-xl-7 col-lg-8">
                    <div className="booking-lists">
                      <ul className="nav">
                        ...
                        <li><Link className="active" to={routes.userBookingCancelled}>Cancelled</Link></li>
                      </ul>
                    </div>
                  </div>
              ...
              <div className="card book-card flex-fill mb-0">
                <div className="card-header">
                  <div className="row align-items-center">
                    <div className="col-md-5"><h4>Cancelled <span>{filteredData.length}</span></h4></div>
                ...
                <div className="card-body">
                  {loading ? (
                    ...
                    <div className="table-responsive dashboard-table">
                      <DataTable className="table datatable" value={filteredData} emptyMessage="No cancelled bookings.">
      ...
      <BookingModal booking={selectedBooking} userInfo={userInfo} modalId="cancelled_modal" />
    </>
  );
};
