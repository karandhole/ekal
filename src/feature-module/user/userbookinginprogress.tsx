...
const UserBookingInprogress = () => {
  ...
  useEffect(() => {
    ...
    const fetch = async () => {
      try {
        ...
        console.error("Failed to fetch inprogress:", e);
      } finally {
        setLoading(false);
      }
    };
  ...
  const BookingId = (res: any) => (
    <Link to="#" data-bs-toggle="modal" data-bs-target="#inprogress_modal" className="bookbyid"
  ...
  const statusBadge = () => <span className="badge badge-light-warning">Inprogress</span>;
  ...
  const action = (res: any) => (
    <div className="dropdown dropdown-action">
      ...
      <div className="dropdown-menu dropdown-menu-end">
        <Link className="dropdown-item" to="#" data-bs-toggle="modal" data-bs-target="#inprogress_modal"
  ...
  return (
    <>
              ...
              <div className="card book-card flex-fill mb-0">
                <div className="card-header">
                  <div className="row align-items-center">
                    <div className="col-md-5"><h4>Inprogress <span>{filteredData.length}</span></h4></div>
                ...
                <div className="card-body">
                  {loading ? (
                    ...
                    <div className="table-responsive dashboard-table">
                      <DataTable className="table datatable" value={filteredData} emptyMessage="No in-progress bookings.">
      ...
      <BookingModal booking={selectedBooking} userInfo={userInfo} modalId="inprogress_modal" />
    </>
  );
};
